        ...
        <ul class="nav nav-list">
            ...
            <li class="@yield('activeC')">
                ...
                <ul class="submenu">
                    ...
                    <li class="@yield('abledC')">
                        <a href="{{ url('/category/enabled') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
            ...
            <li class="@yield('activeU')">
                ...
                <ul class="submenu">
                    ...
                    <li class="@yield('abledU')">
                        <a href="{{ url('/users/enabled') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Habilitar usuarios
                        </a>
            ...
            <li class="@yield('activeF')">
                ...
                <ul class="submenu">
                    ...
                    <li class="@yield('abledF')">
                        <a href="{{ url('/films/enabled') }}">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Habilitar película
                        </a>
